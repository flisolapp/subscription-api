...
{
    /**
     * POST /subscriptions/collaborators
     *
     * Creates a People record, a Collaborator, and its related
     * CollaboratorArea[] + CollaboratorAvailability[] rows, all inside a
     * single transaction.
     *
     * S3 photo path: people/{people_id}/photos/{uuidv7}.{ext}
     */
    public function store(StoreCollaboratorRequest $request): JsonResponse
    {
        ...
        try {
            ...
            // ── 4. Attach collaboration areas ─────────────────────────────────
            // areas[] is an array of collaboration_area_id values
            $areaRows = array_map(
                fn (int $areaId) => [
            ...
            // ── 5. Attach availability shifts ─────────────────────────────────
            // availabilities[] is an array of collaborator_shift_id values
